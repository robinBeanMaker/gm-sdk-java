...
import com.trustasia.tagm.core.auth.ApiKeyAuth;
import com.trustasia.tagm.core.auth.Authentication;
import com.trustasia.tagm.core.auth.HttpBasicAuth;
import com.trustasia.tagm.sign.TaGmSignBuilder;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "https://localhost:9090";
    ...
    private com.trustasia.tagm.sign.Credentials credentials;
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:9003
     ...
     * @see
     * <a href="https://docs.oracle.com/javase/7/docs/api/java/nio/file/Files.html#createTempFile(java.lang.String,%20java.lang.String,%20java.nio.file.attribute.FileAttribute...)">createTempFile</a>
     */
    ...
    public Call buildCall(String baseUrl, String path, String method, List<Pair> queryParams,
                          List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String
            , String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
    ...
    public Request buildRequest(String baseUrl, String path, String method, List<Pair> queryParams,
        ...
        signRequest(authNames, allQueryParams, headerParams, cookieParams, requestBodyToString(reqBody),
     ...
     */
    public void signRequest(String[] authNames, List<Pair> queryParams, Map<String, String> headerParams,
                            Map<String, String> cookieParams, String payload, String method, URI uri) throws ApiException {
        String clientCert = credentials.getClientCert();
        String priKey = credentials.getPriKey();
        if (StringUtils.isBlank(clientCert) || StringUtils.isBlank(priKey)) {
            throw new ApiException("Client certificate and private key must be provided for signing.");
        }
        // 构造签名
        String timestamp = System.currentTimeMillis() + "";
        String randomStr = UUID.randomUUID().toString().substring(0, 8);
        String sign = TaGmSignBuilder.builder()
                .timestamp(timestamp)
                .random(randomStr)
                .body(payload)
                .uri(uri)
                ...
                .build();
        // 设置请求头
        headerParams.put("x-sign", sign);
        headerParams.put("x-random", randomStr);
        headerParams.put("x-time", timestamp);
    }

    public void setCredentials(com.trustasia.tagm.sign.Credentials credentials) {
        this.credentials = credentials;
    }

    public com.trustasia.tagm.sign.Credentials getCredentials() {
        return credentials;
    }
